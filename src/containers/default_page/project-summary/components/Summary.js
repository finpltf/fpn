        ...
        <Card>
          <CardBody>
            <div className='FundPage'>
              ...
              <Button className='FundPage__btn' outline size='sm'>Edit</Button>
              <table className='FundPage__info'>
                <tbody>
                <tr>
                  <th>Project owner:</th>
                  <td>Mary McCorny</td>
              ...
              <div className='FundPage__stats'>
                <div className='FundPage__stat'>
                ...
                <div className='FundPage__progress progress-wrap progress-wrap--middle'>
