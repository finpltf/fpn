  ...
  render() {
    return (
      <div className='FundPage__statistics'>
        ...
        <Button className='FundPage__btn' outline size='sm' onClick={this.onUpdate}>Update Data</Button>
        <div className='FundPage__statistic'>
          <p className='FundPage__statistic-title'>Task Statistic</p>
        ...
        <div className='FundPage__statistic'>
          <p className='FundPage__statistic-title'>Bug Statistic</p>
