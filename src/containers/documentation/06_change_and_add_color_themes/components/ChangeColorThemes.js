...
export default class ChangeColorThemes extends PureComponent {
  render() {
    return (
      <Card className='card--not-full-height'>
        <CardBody>
          ...
          <p>We have created light and dark color theme for this template. All color variables are
            in <b>template/src/scss/settings/variables.scss</b> file. Both themes look like the following:</p>
          <CodeHighlither scss>
            {`$themes: (
  light: (
