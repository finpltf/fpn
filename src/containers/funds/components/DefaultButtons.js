        ...
        <Card>
          <CardBody>
            <div className='card__title'>
              ...
              <h5 className='subhead'>Use default button with necessary values of properties <span
                className='red-text'>color</span>, <span className='red-text'>outline</span> and <span
                  className='red-text'>disabled</span></h5>
            </div>
            <div className='card__title'>
              <h5 className='subhead'>Modifier color <span className='red-text'>primary</span>, <span
                className='red-text'>success</span>, <span className='red-text'>warning</span>, <span
                  className='red-text'>danger</span></h5>
              <h5 className='subhead'>Modifier outline and disabled <span className='red-text'>true</span>, <span
                className='red-text'>false</span></h5>
            </div>
            <ButtonToolbar>
