        ...
        <Container>
          <Row>
            <Col md={12}>
              ...
              <Link className='landing__btn landing__btn--header' to='/documentation/introduction' target='_blank'>Зарегистрироваться</Link>                        
              <button className='landing__btn2' onClick={() => scrollToComponent(this.Demos, {offset: -50, align: 'top', duration: 1500})}>Узнать больше</button>
