    ...
    return (
      <div className='landing__header page' style={{ backgroundImage: 'url(' + background + ')' }}>
        <Container>
          <Row>
            <Col md={12}>
              <h2 className='landing__header-title'>Игвестируйте в ПИФы онлайн<br />
              </h2>
              ...
              <p class="landing__header-subhead">
                ...
                Мы наладили сотрудничество с надежными управляющими компаниями и сделали процесс управления инвестициями простым и понятным.
                <br />
