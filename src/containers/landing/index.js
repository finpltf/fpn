          ...
          <Col md={6} sm={12} xs={12}>
            <div className='landing__code-text'>
              <div className='landing__code-wrap'>
                ...
                <p>Вы легко можете отфильтровать и сравнить паевые инвестиционные фонды, представленные в нашей витрине, по разным показателям, важным именно для вас.</p>
          ...
          <Col md={6} sm={12} xs={12}>
            <div className='landing__code-text'>
              <div className='landing__code-wrap'>
                ...
                <p>Удобно структурированная информация об управляющей компании и ее фондах позволяет, не покидая сайт, получить точное представление о каждом финансовом продукте, доступном на Финансовой платформе. С карточки фонда вы можете перейти непосредственно к приобретению паев. </p>
          ...
          <Col md={6} sm={12} xs={12}>
            <div className='landing__code-text'>
              <div className='landing__code-wrap'>
                ...
                <p>Управление инвестпортфелем из единого интерфейса. Уведомления и документы. Коммуникации с управляющими компаниями. Персональная аналитика. Всё это специально для вас. </p>
