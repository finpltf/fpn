    ...
    return (
      <div className='sidebar__content'>
        <ul className='sidebar__block'>
          <SidebarLink title='Рабочий стол' icon='home' route='/dashboard' onClick={this.hideSidebar} />
          ...
          <SidebarCategory title='Default Pages' icon='file-empty'>
            ...
            <SidebarLink title='Search Results' route='/funds_list' onClick={this.hideSidebar} />
