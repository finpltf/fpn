  ...
  render() {
    ...
    return ( 
      <Col md={6} xl={4} sd={12}>
        <Card>
          <CardBody>
          <NavLink className='fund__card' to={'/ui/fundPage'} onClick={this.props.onClick}>
              ...
              <div className='graph'>
            <ResponsiveContainer height={35} className='dashboard__area'>
 

              	<AreaChart data={dataSolidInvest}            
            reverseStackOrder={false}
            >        
       <XAxis dataKey="dataDate" hide={true}/>       
       <Tooltip content={<CustomTooltip/>}/>
       <Area dataKey="navOne"  fillOpacity={0.3} name="Стоимость пая" stroke='#999' fill='#eee'  />              
      </AreaChart>
              ...
              <div className="col-7">                
                <h4 className='subhead'>Доходность за год</h4>
                
                <h3 className='semibold-text plus'>+19.05%</h3>
              </div>

 
              <div className="col-5 grid__small text-right">
                <h4 className='subhead'>Инвестиция от</h4>
